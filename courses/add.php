...
$sql = "SELECT MAX(id) AS max_id FROM courses";
    ...
    <div class="row justify-content-center">
        <div class="col-md-7">
            <div class="bg-white p-5 form-card">
                <h2 class="text-center mb-4"><u>Course - Add Record</u></h2>
...
?>
                            <option value="<?= $dept_row['id'] ?>"><?= htmlspecialchars($dept_row['dept_name']) ?></option>
<?php
    }
}
?>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="duration" name="duration" placeholder="Enter duration in years">
                    </div>
