...
$sql = "SELECT * FROM designation WHERE id = $user_id";
...
<head>
    ...
    <title>Designation - Edit Record</title>
    ...
    <div class="row justify-content-center">
        <div class="col-md-7">
            <div class="bg-white p-5 form-card">
                <h2 class="text-center mb-4"><u>Designation - Edit Record</u></h2>
                ...
                <form class="row g-3" action="update.php" method="post">
                    ...
                    <div class="col-md-9">
                        ...
                        <input type="text" class="form-control" id="designation" name="designation" value="<?= htmlspecialchars($designation) ?>" required>
                    </div>
