...
$sql = "SELECT MAX(id) AS max_id FROM departments";
...
<head>
    ...
    <title>Department - Add Record</title>
    ...
    <div class="row justify-content-center">
        <div class="col-md-7">
            <div class="bg-white p-5 form-card">
                <h2 class="text-center mb-4"><u>Department - Add Record</u></h2>
                ...
                <form class="row g-3" action="create.php" method="post">
                    ...
                    <div class="col-md-9">
                        ...
                        <input type="text" class="form-control" id="dept_name" name="dept_name" placeholder="Enter department name" required>
                    </div>
