    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="bg-white p-4 card-box">
                <h3 class="text-center text-primary mb-4">Staff - Record List</h3>
...
?>
        <tr>
            ...
            <td><?= htmlspecialchars($row['designation_name'] ?? 'Not Assigned') ?></td>
...
<?php
    ...
    echo "<tr><td colspan='8' class='text-danger'>No records found</td></tr>";
}
?>
                        </tbody>
                    </table>
